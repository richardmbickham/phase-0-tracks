...
# What are the differences between the two different hash syntaxes shown in the state_data file?
  # One uses string as key; nested hash uses symbol
# What does require_relative do? How is it different from require?
  # Require relative accesses code of another file in the same location as the current file; require has a path to a specific source
# What are some ways to iterate through a hash?
  # .each or .map
# When refactoring virus_effects, what stood out to you about the variables, if anything?
  # the repetition; knew immediately that there would be a cleaner solution
# What concept did you most solidify in this challenge?
  # Refactoring better; making code more readable 
